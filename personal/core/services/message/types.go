...
type MessageQueueConfig struct {
	...
	// Personal Pro: Enhanced Anti-bot
	AntiBotEnabled     bool // Global toggle for enhanced anti-bot measures
	RandomSuffixLength int  // Length of random string to append to messages (0 to disable)
}
